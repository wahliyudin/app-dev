...
class RequestController extends Controller
{
    ...
    public function datatable()
    {
        ...
        return datatables()->of($data)
            ...
            ->addColumn('is_edit', fn($data) => hasPermission('request_update') && $data->status != Status::CLOSE)
            ->addColumn('is_delete', fn($data) => hasPermission('request_delete') && $data->status != Status::CLOSE)
