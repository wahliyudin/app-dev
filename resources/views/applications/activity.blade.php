        ...
        <div class="card">
                    ...
                    <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0 fw-bold"
                        ...
                        <li class="nav-item" role="presentation">
                            <a id="kt_activity_year_tab"
                                ...
                                data-bs-toggle="tab" role="tab" href="#kt_activity_year">
                                2023 </a>
                        </li>
                    </ul>
                    <!--end::Tab nav-->
            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                        ...
                        <div class="timeline">
                            ...
                            <div class="timeline-item">
                                ...
                                <div
                                    ...
                                    <div class="symbol-label bg-light">
                                        <i
                                            class="ki-duotone ki-message-text-2 fs-2 text-gray-500"><span
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="pe-3 mb-5">
                                        <!--begin::Title-->
                                        <div class="fs-5 fw-semibold mb-2">There are 2 new tasks
                                        ...
                                        <div class="d-flex align-items-center mt-1 fs-6">
                                            <!--begin::Info-->
                                            <div class="text-muted me-2 fs-7">Added at 4:23 PM
                                                by</div>
                                            <!--end::Info-->
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content mb-10 mt-n2">
                                    ...
                                    <div class="overflow-auto pe-3">
                                        <!--begin::Title-->
                                        <div class="fs-5 fw-semibold mb-2">Invitation for
                                            crafting engaging designs that speak human workshop
                                        </div>
                                        <!--end::Title-->
                                    ...
                                    <div class="overflow-auto pb-5">
                                        <div
                                            ...
                                            <div
                                                class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                <!--begin::Icon-->
                                                <img alt="/keen/demo1/../demo1/apps/projects/project.html"
                                                    class="w-30px me-3"
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="pe-3 mb-5">
                                        ...
                                        <div class="fs-5 fw-semibold mb-2">
                                            ...
                                            merged with <a href="#"
                                                class="text-primary fw-bold me-1">#45890</a> in
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="pe-3 mb-5">
                                        <!--begin::Title-->
                                        <div class="fs-5 fw-semibold mb-2">3 new application
                                            design concepts added:</div>
                                        <!--end::Title-->

                                        <!--begin::Description-->
                                        <div class="d-flex align-items-center mt-1 fs-6">
                                            <!--begin::Info-->
                                            <div class="text-muted me-2 fs-7">Created at 4:23 PM
                                                by</div>
                                            <!--end::Info-->
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-icon symbol symbol-circle symbol-40px">
                                    <div class="symbol-label bg-light">
                                        <i class="ki-duotone ki-sms fs-2 text-gray-500"><span
                                                class="path1"></span><span
                                                class="path2"></span></i>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="pe-3 mb-5">
                                        ...
                                        <div class="overflow-auto pb-5">
                                            ...
                                            <div class="d-flex align-items-center mt-1 fs-6">
                                                <!--begin::Info-->
                                                <div class="text-muted me-2 fs-7">Added at 4:23
                                                    PM by</div>
                                                <!--end::Info-->
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="pe-3 mb-5">
                                        <!--begin::Title-->
                                        <div class="fs-5 fw-semibold mb-2">You have received a
                                            new order:</div>
                                        <!--end::Title-->
                                        ...
                                        <div class="d-flex align-items-center mt-1 fs-6">
                                            <!--begin::Info-->
                                            <div class="text-muted me-2 fs-7">Placed at 5:05 AM
                                                by</div>
                                            <!--end::Info-->
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="mb-3 mb-md-0 fw-semibold">
                                                    <h4 class="text-gray-900 fw-bold">Database
                                                        Backup Process Completed!</h4>

                                                    <div class="fs-6 text-gray-700 pe-7">Login
                                                        into Admin Dashboard to make sure the
                                                        data integrity is OK</div>
                                                </div>
                                                <!--end::Content-->
                    ...
                    <!--begin::Tab panel-->
                    <div id="kt_activity_week" class="card-body p-0 tab-pane fade show"
                    ...
                    <!--begin::Tab panel-->
                    <div id="kt_activity_month" class="card-body p-0 tab-pane fade show"
                    ...
                    <!--begin::Tab panel-->
                    <div id="kt_activity_year" class="card-body p-0 tab-pane fade show"
...
@push('js')
    <script type="module" src="{{ asset('assets/js/pages/applications/activity/index.js') }}"></script>
@endpush
