    ...
    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex flex-stack ">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">Developer</li>
            </ul>
        </div>
    </div>
@endsection
...
@push('modal')
    <div class="modal fade" tabindex="-1" id="modal-developer">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Form Developer</h3>
                    ...
                    <form action="" id="modal-form">
                        ...
                        <div class="row gap-2">
                            <div class="col-md-12">
                                ...
                                <select name="developer_nik" id="select-developer" class="form-select"
                                    data-control="select2" data-dropdown-parent="#modal-developer"
...
@push('js')
    ...
    <script type="module" src="{{ asset('assets/js/pages/applications/developer/index.js') }}?v={{ config('app.version') }}"></script>
@endpush
