                        ...
                        <div class="card-body">
                            <form action="" method="POST" class="form-{{ $settingApproval['module'] }}"
                                ...
                                <div class="form-group">
                                    <div data-repeater-list="{{ $settingApproval['module'] }}"
                                        class="d-flex flex-column gap-3">
                                        @forelse ($settingApproval['childs'] as $child)
                                            <x-setting.approval.item :child="$child" :settingApproval="$settingApproval"
                                                :employees="$employees" />
                                        @empty
                                            <x-setting.approval.item :child="null" :settingApproval="$settingApproval"
                                                :employees="$employees" />
                                        @endforelse
                                    </div>
                                </div>
                                @permission('setting_approval_create|setting_approval_update')
                                    <div class="form-group mt-3 d-flex align-items-center justify-content-between">
                                        @permission('setting_approval_create')
                                        ...
                                        @endpermission
                                        @permission('setting_approval_update')
